          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center' }}>
            ...
            <div className="fade-up-2" style={{ animation: 'float 6s ease-in-out infinite' }}>
              <div style={{
                ...
                {/* Card header */}
                <div style={{ background: 'var(--accent)', padding: '8px 8px 44px', position: 'relative' }}>
                ...
                {/* Photo */}
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 24px 24px', marginTop: -20 }}>
